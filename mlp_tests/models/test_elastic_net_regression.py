...
import mlp.models.elastic_net_regression as linear_regression

class Test_elastic_net_regression(unittest.TestCase):
    ...
    def test_1000_coplanar_10d(self):
        ...
        npt.assert_almost_equal(model.intercept_ / np.linalg.norm(model_normal), np.dot(-offset_vector, m_v[dim - 1]),
                                decimal=6)
